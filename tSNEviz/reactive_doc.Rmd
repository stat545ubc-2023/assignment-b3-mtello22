...
zip_file_path <- file.path(data_dir, "GSE72056_exp_df.zip")
tsv_file_name <- "GSE72056_exp_df.tsv"
# Unzip the contents of the .zip file
unzip(zip_file_path, files = tsv_file_name, exdir = tempdir())
# Read the .tsv file using fread
exp_dt <- fread(file.path(tempdir(), tsv_file_name))
...
Please note that the following section will display an Error until you have generate an input tSNE plot since the variability range for the histogram is dictated by the subset of cells.
